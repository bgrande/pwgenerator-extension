...
chrome.storage.local.get('settings', function (items) {
    ...
    if (passwords.length > 0) {
        ...
        for (var i = 0; i < passwords.length; i++) {
            Object.create(VaultGenerator).init(SETTINGS, passwords[i], vaultSettings, DEFAULT_SETTINGS);
        }
        ...
        Object.create(VaultGenerator).init(SETTINGS, password, vaultSettings, DEFAULT_SETTINGS);
    }
});